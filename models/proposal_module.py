...
from Graph_based_module import PAM_Module, CAM_Module, DANetHead, SENet
...
class ProposalModule(nn.Module):
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr, num_proposal, sampling, seed_feat_dim=256):
        ...
        self.SENet = SENet(128,128)
        self.DANet = DANetHead(128,128)
        ...
        self.conv_class = torch.nn.Conv1d(128, self.num_class, 1)
    ...
    def forward(self, xyz, features, end_points):
        ...
        the_sem_cls_scores = self.conv_class(net)
        net = self.conv3(net) # (batch_size, 2+3+num_heading_bin*2+num_size_cluster*4, num_proposal)
        net = torch.cat([net, the_sem_cls_scores], 1)
