...
class PAM_Module(nn.Module):
    ...
    def forward(self, x):#输入Batch X N X Feature
...
class DANetHead(nn.Module):
    def __init__(self,in_channels, out_channels):
        ...
        self.conv1 = nn.Sequential(nn.Dropout(0.1,False), nn.Conv1d(in_channels, out_channels, 1))
        self.conv2 = nn.Sequential(nn.Dropout(0.1, False), nn.Conv1d(in_channels, out_channels, 1))
        self.conv3 = nn.Sequential(nn.Dropout(0.1, False), nn.Conv1d(in_channels, out_channels, 1))
